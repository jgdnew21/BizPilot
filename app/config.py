...
class Settings:
    ...
    erpnext_base_url: str = os.getenv("ERPNEXT_BASE_URL", "http://hst.localhost:8080")
    ...
    default_purchase_warehouse: str = os.getenv("DEFAULT_WAREHOUSE", "南宁华食泰 - 华食泰")
    default_purchase_supplier: str = os.getenv("DEFAULT_PURCHASE_SUPPLIER", "其它")
